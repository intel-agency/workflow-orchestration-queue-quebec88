...
>
> **Scope:** Template repo `workflow-orchestration-queue-quebec88` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
